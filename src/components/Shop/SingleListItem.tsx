...
import { truncateString } from "@/app/_utils/utils";
    ...
    <div className="group rounded-lg bg-white shadow-1">
      <div className="flex">
        <div className="shadow-list relative overflow-hidden flex items-center justify-center max-w-[270px] w-full sm:min-h-[270px] p-4">
          <Image src={item.cover_image} alt="" width={250} height={250} />
        ...
        <div className="w-full flex flex-col gap-5 sm:flex-row sm:items-center justify-center sm:justify-between py-5 px-4 sm:px-7.5 lg:pl-11 lg:pr-12">
          <div>
            <h3 className="text-dark ease-out duration-200 hover:text-blue mb-1.5">
              <Link href="/shop-details"> {truncateString(item.name, 90)} </Link>
            </h3>
          ...
          <div className="flex items-center gap-2.5 mb-2">
            ...
            <p className="text-custom-sm">({item.total_rating})</p>
          </div>
        </div>
      </div>
    </div>
